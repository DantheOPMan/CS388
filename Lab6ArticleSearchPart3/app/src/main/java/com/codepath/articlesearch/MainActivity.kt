...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set default selection and manually replace the fragment
        bottomNavigationView.selectedItemId = R.id.nav_books
        replaceFragment(bestSellerBooksFragment) // Add this line
    }

    private fun replaceFragment(fragment: Fragment) { // Rename parameter for clarity
